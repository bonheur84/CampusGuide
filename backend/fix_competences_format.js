...
async function fixCompetencesFormat() {
  try {
    ...
    console.log('Correction du format des compétences en JSON...');

    // Mettre à jour les clubs avec le format JSON correct
    ...
    for (const [clubId, competences] of Object.entries(clubsCompetences)) {
      ...
      console.log(`Compétences corrigées pour le club ${clubId}`);
    }
