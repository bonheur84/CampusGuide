      ...
      <main className="pb-16">
        ...
        <section className="mt-1 rounded-[20px] py-12 md:py-24 text-center bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[1000px] mx-auto relative z-1 px-6">
            <Link to="/mentors" className="bg-white rounded-2xl p-10 md:p-12 text-center border border-slate-200 transition-all duration-200 cursor-pointer no-underline hover:bg-bg hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
              <div className="w-24 h-24 rounded-xl flex items-center justify-center mx-auto mb-8 text-4xl bg-orange-50 text-orange-600"><i className="fa-solid fa-people-arrows"></i></div>
            ...
            <Link to="/campus" className="bg-white rounded-2xl p-10 md:p-12 text-center border border-slate-200 transition-all duration-200 cursor-pointer no-underline hover:bg-bg hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
              <div className="w-24 h-24 rounded-xl flex items-center justify-center mx-auto mb-8 text-4xl bg-sky-50 text-sky-600"><i className="fa-solid fa-map-marked-alt"></i></div>
            ...
            <Link to="/clubs" className="bg-white rounded-2xl p-10 md:p-12 text-center border border-slate-200 transition-all duration-200 cursor-pointer no-underline hover:bg-bg hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
              <div className="w-24 h-24 rounded-xl flex items-center justify-center mx-auto mb-8 text-4xl bg-green-50 text-green-600"><i className="fa-solid fa-users"></i></div>
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Clubs & Associations</h3>
              <p className="text-lg text-slate-500 leading-relaxed">Découvrez les clubs disponibles et rejoignez une communauté qui vous ressemble.</p>
            </Link>
            <Link to="/orientation" className="bg-white rounded-2xl p-10 md:p-12 text-center border border-slate-200 transition-all duration-200 cursor-pointer no-underline hover:bg-bg hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
              <div className="w-24 h-24 rounded-xl flex items-center justify-center mx-auto mb-8 text-4xl bg-teal-50 text-teal-600"><i className="fa-solid fa-compass"></i></div>
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Orientation Filières</h3>
              <p className="text-lg text-slate-500 leading-relaxed">Répondez à quelques questions et découvrez la filière qui correspond à vos aspirations.</p>
            </Link>
            <Link to="/calendrier" className="bg-white rounded-2xl p-10 md:p-12 text-center border border-slate-200 transition-all duration-200 cursor-pointer no-underline hover:bg-bg hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
              <div className="w-24 h-24 rounded-xl flex items-center justify-center mx-auto mb-8 text-4xl bg-red-50 text-red-600"><i className="fa-solid fa-calendar-alt"></i></div>
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Calendrier Académique</h3>
              <p className="text-lg text-slate-500 leading-relaxed">Consultez toutes les dates importantes : examens, inscriptions, événements.</p>
            </Link>
            <Link to="/guide" className="bg-white rounded-2xl p-10 md:p-12 text-center border border-slate-200 transition-all duration-200 cursor-pointer no-underline hover:bg-bg hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
              <div className="w-24 h-24 rounded-xl flex items-center justify-center mx-auto mb-8 text-4xl bg-blue-50 text-blue-600"><i className="fa-solid fa-play-circle"></i></div>
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Guide du Nouvel Étudiant</h3>
